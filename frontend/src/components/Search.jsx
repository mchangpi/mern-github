  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <button
          type="submit"
          className="absolute bottom-2.5 end-2.5 rounded-lg bg-blue-700 bg-gradient-to-r from-cyan-800 to-blue-500 px-4 py-2 text-sm font-medium text-white transition-all  duration-300 hover:scale-95 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 active:scale-90"
        >
          Search
        </button>
      </div>
